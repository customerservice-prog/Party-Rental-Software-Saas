...
export default function HomeScreen(){
 ...
 return <section className="tenant-panel phase2-office-tool">
  ...
  <div className="phase2-video-stage">{videoId?<iframe src={"https://www.youtube.com/embed/"+videoId} title="Office screen" allow="autoplay; encrypted-media; picture-in-picture" allowFullScreen/>:<div><span>▶</span><b>No video playing</b><small>Paste a YouTube link below when you need it.</small></div>}</div>
