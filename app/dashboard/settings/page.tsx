...
export default function SettingsPage() {
  ...
  const inputClass = "block w-full border border-gray-300 rounded-md px-3 py-2 text-sm";
  const labelClass = "block mb-4";
  const labelTextClass = "block text-sm font-medium text-gray-700 mb-1";
  const buttonClass =
    "bg-indigo-600 text-white rounded-md px-4 py-2 text-sm font-medium disabled:opacity-50 hover:bg-indigo-700";
  const sectionClass = "bg-white shadow rounded-lg p-6 mb-8";
