...
export default function SchedulingCalendar({
  ...
  return (
    <div>
      ...
      {selectedDay && (
        <div className="friendly-admin-card mt-4">
            ...
            {selectedOrders.map((order) => {
              ...
              return (
                <div key={order.id} className="border rounded-md overflow-hidden">
                  <div className="bg-[#1a3a1a] text-white text-sm px-3 py-2 flex items-center justify-between">
                  ...
                  <div className="p-3 text-sm space-y-2">
                    ...
                    <div className="flex gap-2 pt-2">
                      ...
                      <button
                        ...
                        className="friendly-admin-primary !min-h-0 !px-3 !py-1 disabled:opacity-50"
                      >
