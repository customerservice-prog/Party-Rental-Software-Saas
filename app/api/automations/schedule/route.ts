...
export async function PATCH(request:Request){try{
 ...
 if(!body||typeof body.enabled!=='boolean'||typeof body.emailEnabled!=='boolean'||typeof body.smsEnabled!=='boolean'||!Number.isInteger(body.dailyLimit)||body.dailyLimit<1||body.dailyLimit>100||!Number.isInteger(body.startHour)||body.startHour<0||body.startHour>23||!Number.isInteger(body.endHour)||body.endHour<=body.startHour||body.endHour>24||body.enabled&&(!body.emailEnabled&&!body.smsEnabled||body.confirmNewBookingsOnly!==true)||body.smsEnabled&&body.smsPermissionConfirmed!==true)return NextResponse.json({error:'Review delivery channels, a 1–100 rolling-24-hour limit, local-time hours and the required confirmations.'},{status:400});
