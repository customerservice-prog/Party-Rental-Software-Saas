...
export function adminCapabilityForPath(path:string):PlatformCapability{
 ...
 return ({users:'support',onboarding:'support',billing:'billing',revenue:'billing',analytics:'analytics',insights:'analytics',health:'operations',integrations:'operations',operations:'operations','automation-worker':'operations',alerts:'operations','catalog-templates':'catalog','catalog-readiness':'catalog',communications:'communications',data:'data',security:'security',sessions:'security',access:'security',settings:'platform','feature-flags':'platform','audit-log':'platform'} as Record<string,PlatformCapability>)[path.split('/')[2]]||'platform';
}
